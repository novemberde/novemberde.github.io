---
title: "Working Speed in the AI Era: Driving a Car at Horse-Carriage Pace"
tags: ["ai", "productivity", "leadership", "career"]
...
I touched on this in a [previous post about how I use Claude](/post/2026/02/17/how-i-use-claude-engineer-ai-workflow-ko/). After a year of working with AI tools, the biggest change wasn't the speed of work — it was the **density** of work. Instead of doing more in the same time, the time I used to spend on boilerplate and repetitive tasks shifted to design and decision-making. Less time typing code, more time **thinking** about code. This is exactly the carriage-to-automobile transition. Not traveling the same distance faster, but fundamentally changing the quality of what you can do along the way.
...
- [Locomotive Acts - Wikipedia](https://en.wikipedia.org/wiki/Locomotive_Acts) — The history of the Red Flag Act enacted in England in 1865. A person carrying a red flag was required to walk 60 yards ahead of every automobile, with speed limits of 2 mph in towns and 4 mph in the country. The law persisted for over 30 years before being repealed in 1896.
- [Red flag traffic laws - Wikipedia](https://en.wikipedia.org/wiki/Red_flag_traffic_laws) — Historical context on how regulations were applied to new technologies, not just in England but worldwide.
